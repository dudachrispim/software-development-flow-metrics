...
OUTPUT_PATH = SEARCH_DIR / "repos_search_10_5000.csv"
REJECTED_OUTPUT_PATH = SEARCH_DIR / "repos_search_10_5000_rejected.csv"
STATE_PATH = SEARCH_DIR / "search_state_10_5000.json"

BASE_QUERY = "is:public archived:false has:issues pushed:>2020-01-01"

SEARCH_QUERIES = [
    {"label": "stars_10_20", "query": f"{BASE_QUERY} stars:10..20", "target": 500},
    {"label": "stars_21_35", "query": f"{BASE_QUERY} stars:21..35", "target": 500},
    {"label": "stars_36_50", "query": f"{BASE_QUERY} stars:36..50", "target": 500},
    {"label": "stars_51_75", "query": f"{BASE_QUERY} stars:51..75", "target": 500},
    {"label": "stars_76_100", "query": f"{BASE_QUERY} stars:76..100", "target": 500},

    {"label": "stars_101_150", "query": f"{BASE_QUERY} stars:101..150", "target": 500},
    {"label": "stars_151_250", "query": f"{BASE_QUERY} stars:151..250", "target": 500},
    {"label": "stars_251_350", "query": f"{BASE_QUERY} stars:251..350", "target": 500},
    {"label": "stars_351_500", "query": f"{BASE_QUERY} stars:351..500", "target": 500},

    {"label": "stars_501_750", "query": f"{BASE_QUERY} stars:501..750", "target": 500},
    {"label": "stars_751_1000", "query": f"{BASE_QUERY} stars:751..1000", "target": 500},
    {"label": "stars_1001_1500", "query": f"{BASE_QUERY} stars:1001..1500", "target": 500},
    {"label": "stars_1501_2000", "query": f"{BASE_QUERY} stars:1501..2000", "target": 500},

    {"label": "stars_2001_3500", "query": f"{BASE_QUERY} stars:2001..3500", "target": 500},
    {"label": "stars_3501_5000", "query": f"{BASE_QUERY} stars:3501..5000", "target": 500},
